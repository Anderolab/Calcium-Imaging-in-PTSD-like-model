...
load('F:\Ex3_BLA\DLC\SPT_ms_new\ms_M11_SPT.mat', 'ms');
...
save('F:\Ex3_BLA\DLC\Good_neurones\Good_Neurones_SPT\good_neurons_M11.mat', 'good_neurons');

% Opcional: guardar los índices de las buenas neuronas
good_neurons_indices = find(good_neurons);
save('F:\Ex3_BLA\DLC\Good_neurones\Good_Neurones_SPT\good_neurons_11_index.mat', 'good_neurons_indices');
