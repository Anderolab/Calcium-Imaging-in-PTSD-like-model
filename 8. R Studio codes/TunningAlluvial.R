...
# ===========Alluvial plot from merged_neurons_all_animals.csv==================
...
# -----------------------------Path to the CSV----------------------------------
xlsx_file <- "F:/Ex3_BLA/Calcium RESULTS/Results_CellReg/OR_SI_results/merged_metrics_tuning_object_doll.xlsx"
...
# --------- Alluvial plot of state transitions by sex × treatment (%) ----------
...
# # --------- Alluvial plot of state transitions global (%) ----------- OPTIONAL
# 
...
# # 
# # 
# # --------- Alluvial plot of state transitions by treatment (%) ----- OPTIONAL
