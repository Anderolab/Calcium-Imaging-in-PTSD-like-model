function [finalTable, only_E, only_L]  = CreateTable_IMO_Normal(Matrics_Early,loadedDataMatrics_2, testName2)

    % Example: your table is called 'data'
    index_2 = ['Index_' testName2];
    excludeCols = {'Animal', 'Sex', 'Treatment', 'Sexo', 'Tratamiento', 'Index_E', 'Index_L' index_2}; % columns to exclude
