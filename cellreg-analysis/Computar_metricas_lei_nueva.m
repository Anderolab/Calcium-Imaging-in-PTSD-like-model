...
%%
% Obtén todos los nombres de los animales en Experiment.SPT
...
%              Experiment.SPT.(animal).Task.Titles{t} = newTitle;
%          end
% 
...
% Obtener los nombres de los campos actuales en Experiment.SPT 
...
% Crear una nueva estructura para Experiment.SPT con los nuevos nombres 
...
% Asignar la nueva estructura a Experiment.SPT 
...
folder_path = 'E:\Ex3_BLA\DLC\SPT_metricas\DF_F';
...
outputFolder = fullfile(['E:\Ex3_BLA\DLC\SPT_metricas\CaRATE']);
...
for c = 1:numel(intervalCategories)
    ...
    for g = 1:size(groupNames,1) %numAnimals
        ...
        A=[A;auxData3];
        % Guardar la tabla en un archivo CSV
        folder_path = 'E:\Ex3_BLA\DLC\SPT_metricas\CaRATE';
        folder_path = strcat(folder_path,'\Results_SPTnoutliers',groupNames(g));
